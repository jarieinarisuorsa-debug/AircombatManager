...
export function initEventActions() {
  ...
  registerAction("delete-event", (event, button) => {
    requireAdmin(getState());
    openConfirmModal({
      title: "Poista kilpailu",
      message: "Olet poistamassa kilpailua ja siihen liittyviä osallistujia, heatteja ja tuloksia. Tätä toimintoa ei voi perua.",
      requireText: "POISTA",
